...
// ─── LANDING ───────────────────────────────────────────────────────────────
function LandingScreen2({ navigate }) {
...
// ─── BUILD PROFILE ─────────────────────────────────────────────────────────
function BuildProfileScreen2({ navigate }) {
...
// ─── DISCOVER ─────────────────────────────────────────────────────────────
function DiscoverScreen2({ navigate }) {
...
// ─── ARCHIVE ───────────────────────────────────────────────────────────────
function ArchiveScreen2({ navigate }) {
...
// ─── PROFILE ───────────────────────────────────────────────────────────────
function ProfileScreen2({ navigate }) {
...
Object.assign(window, {
  LandingScreen2, AuthScreen2, BuildProfileScreen2,
  DiscoverScreen2, ArchiveScreen2, ProfileScreen2,
});
